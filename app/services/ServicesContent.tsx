  ...
  const services = [
    {
      ...
      image: "https://cdn.myportfolio.com/84a10115-639a-4bad-97b6-2c339c170bbc/632ed1aa-5c30-48d1-9538-7adc0075d3c5_car_202x158.jpg?h=9e6297371ff4dada20bec86a76558a3d",
    ...
    },
    {
      ...
      image: "https://cdn.myportfolio.com/84a10115-639a-4bad-97b6-2c339c170bbc/ddd14936-4b50-48df-a7cc-42589b0470e8_rwc_0x570x1151x899x1151.jpg?h=39766322493c32eb006daf16bc821559",
    ...
    },
    {
      ...
      image: "https://cdn.myportfolio.com/84a10115-639a-4bad-97b6-2c339c170bbc/ed3272df-0b1b-4061-b0dc-7c054ecec8b6_rwc_0x777x1336x1044x1336.jpg?h=2bd6a6ba863da2fdf57fb2d92e2b135b",
    ...
    },
    {
      ...
      image: "https://cdn.myportfolio.com/84a10115-639a-4bad-97b6-2c339c170bbc/4430cfba-9320-4520-a2e4-9f7bf3ee3870_car_202x158.jpg?h=a4eb2796b9a22baf24f73e838016c726",
  ...
  return (
    <main className="flex-1 flex flex-col bg-transparent pt-24 min-h-screen">
      ...
      <section className="px-6 py-20 max-w-7xl mx-auto w-full text-center">
        ...
        >
          <h1 className="text-4xl md:text-5xl lg:text-7xl font-black tracking-tight mb-4 text-zinc-900 dark:text-white text-balance">
            Fotografia de Esportes e Eventos
          </h1>
          <p className="text-lg md:text-xl font-bold uppercase tracking-widest text-[#FF8C00] mb-6">
            Sediada em Portugal | Disponível para viagens.
          </p>
          <p className="text-base md:text-lg text-zinc-600 dark:text-zinc-400 max-w-2xl font-light leading-relaxed">
            Fotografia comercial de alto impacto. Focada em registrar e imortalizar os 
            momentos decisivos da ação técnica e da euforia humana, entregando poder e 
            narrativa para a sua marca ou equipe.
          </p>
        </motion.div>
      </section>
              ...
              >
                ...
                <div className="p-6 flex flex-col flex-grow text-zinc-900 dark:text-white">
                  ...
                  <div className="space-y-6 flex-grow">
                    ...
                    <div>
                      <h3 className="text-[10px] font-bold tracking-widest text-[#FF8C00] uppercase mb-3">Para quem é indicado</h3>
                    ...
                    <div>
                      <h3 className="text-[10px] font-bold tracking-widest text-zinc-400 dark:text-white/30 uppercase mb-3">Serviços</h3>
                      <ul className="space-y-2">
                    ...
                    <div>
                      <h3 className="text-[10px] font-bold tracking-widest text-zinc-400 dark:text-white/30 uppercase mb-3">Entregáveis típicos</h3>
                      <ul className="space-y-2">
                  ...
                  <div className="mt-8 pt-6 border-t border-zinc-200 dark:border-white/5">
                    <div className="mb-4">
                      <h3 className="text-[10px] font-bold tracking-widest text-zinc-400 dark:text-white/30 uppercase mb-2">Tarifas iniciais</h3>
      ...
      <section className="py-24 px-6 relative w-full flex justify-center">
        ...
        >
          ENTRE EM CONTATO COMIGO PARA FALAR SOBRE O SEU PROJETO
        </Link>
      </section>
